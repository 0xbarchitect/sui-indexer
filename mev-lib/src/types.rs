...
pub struct LendingMarket {
    ...
    pub flashloan_path: Option<serde_json::Value>,
...
impl From<LendingMarket> for db::models::lending_market::NewLendingMarket {
    fn from(market: LendingMarket) -> Self {
        db::models::lending_market::NewLendingMarket {
...
#[derive(Debug, Clone)]
pub struct CalcHFResult {
    pub hf: Decimal,
    pub debt_usd_amount: Decimal,
    pub collateral_usd_amount: Decimal,
    pub dynamic_liquidation_threshold: Option<Decimal>,
    pub user_borrows: Vec<models::user_borrow::UserBorrowWithCoinInfo>,
    pub user_deposits: Vec<models::user_deposit::UserDepositWithCoinInfo>,
}
